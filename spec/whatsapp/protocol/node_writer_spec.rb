...
describe WhatsApp::Protocol::NodeWriter do
  ...
  it 'should write node' do
    ...
    expect(@writer.write(node)).to eql("\x10\x00\x9Ay\x9C\xCE\xC30]rs\xA9\xF8\x8B\x88\xE4\xB4\xEA\x92-\x0F\xC2G\x9EgGijn\x95L\x9E3\xD6\fp\xD4\xA2\xF9o\x9D\xB3\xE7\t\xBB\x90\xCE3\xE3}[&\x1F/ae\xD0>\xF1\x0FTU\x03N\xC4\xFF\xDCbQ\xC5\x86\x7Fr\x8Eq]\xD74\xF8o\xE5\xD3vQ\x9E\x95\xD6k\xB4\xE1\xC4\xA7+j\xF5d\x06\x95#\"NH\x1FX\x9C\x92\xEAWe\xAE\x98\xC9PP\xB9\r\x1A\x85'yw\xB5E\xD2\xF0\xDC\xAF\xF6\xB4\x1A\xA9\xA8\xCD8O\x0E\x874\xD9h\x91\xF7*-j\xDB\n0k\xDATV\xD9\xA8\x85M\xFF".b)
  end

  it 'should write empty node' do
    # expect(@writer.write(nil)).to eql("\x10\x00\x05\xa2\xa8\x65\x3d\x62".b)
    expect(@writer.write(nil)).to eql("\x10\x00\x05\x816\n0\xB8".b)
  end
  ...
  it 'should start stream' do
    ...
    expect(stream).to eql("WA\x01\x02\x10\x00!y\x9E3\r\xA1-2~\xE5\xFB\x18\xE6\xEA\xB3\xE1\xCB\xD8r\xCER\xC6p\x0Fuk~\e,\x8F^\xA9\x11=".b)
  end
  ...
  it 'should flush buffer' do
    ...
    expect(stream).to eql("\x10\x00\x04\x14\xB9,\x9E".b)
  end
