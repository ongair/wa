...
describe Whatsapp::Api::NodeWriter do
  ...
  it 'sholud write node' do
    child = Whatsapp::Api::Node.new('my-child', {'child-one' => 'value-child-one', 'child-two' => 'value-child-two'}, nil, 'my-child-random-data')
    node  = Whatsapp::Api::Node.new('my-tag', {'one' => 'value-one', 'two' => 'value-two'}, [child], 'my-random-data')
