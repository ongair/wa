  ...
  module Request
    ...
    class Base
      ...
      DEVICES = {
          ...
          android:       {
              user_agent:   'WhatsApp/2.10.768 Android/4.1.1 Device/HTC-HTC_One_X',
              ...
              token:        'c87ebd2669347ee164cdf0dd99aa9f16',
              identity_key: 'S\x16\x0FR\x03\nD\x8C\xD5n\xF8\xAF\x8D\xF9\xE5\xBD\xC9\xCCF:!i)WA'
          },
      ...
      def identity(country_code, number, device_id)
